...
const QMetaObjectExtraData NetworkTCP::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject NetworkTCP::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_NetworkTCP,
      qt_meta_data_NetworkTCP, &staticMetaObjectExtraData }
};
