...
#include "../Database/querythread.h"
...
static const char qt_meta_stringdata_QueryThread[] = {
    "QueryThread\0\0model\0queryFinished(QSqlQueryModel*)\0"
};
...
void QueryThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->queryFinished((*reinterpret_cast< QSqlQueryModel*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void QueryThread::queryFinished(QSqlQueryModel * _t1)
{
